...
public class PingAppController {
    ...
    public String getStatus(String username, String password, @PathVariable("id") String id,
        ...
        redirectAttrs.addFlashAttribute("alert_msg", "Ping failed. Credentials invalid");
        return "redirect:/";
