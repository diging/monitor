...
public class UnstorableObjectException extends Exception {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3752626912094283164L;
	...
	public UnstorableObjectException(String message, Throwable cause, boolean enableSuppression,
