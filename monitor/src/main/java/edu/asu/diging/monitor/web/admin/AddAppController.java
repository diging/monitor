...
public class AddAppController {
    ...
    public String add(@ModelAttribute AppForm appForm, RedirectAttributes redirectAttrs, Model model) {
        if (appForm.getUsername().trim().isEmpty() || appForm.getPassword().trim().isEmpty()) {
